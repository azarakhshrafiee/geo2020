...
2. [Wind Field Visualization in Game Engine]
   (https://gdmc.nl/education/topics/topics.html#wind-field-visualization-in-game-engine)
3. [Air temperature estimation through thermal satellite imagery]
   (https://gdmc.nl/education/topics/topics.html#air-temperature-estimation-through-thermal-satellite-imagery)
4. [Improving Building Performance Prediction through Physics-aware Bayesian Neural Network (BNN)]
   (https://gdmc.nl/education/topics/topics.html#improving-building-performance-prediction-through-physics-aware-bayesian-neural-network-bnn)
